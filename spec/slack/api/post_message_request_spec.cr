  ...
  describe "#request_body" do
    it "gets an ok response" do
      ...
      WebMock.stub(:post, "https://slack.com/api/chat.postMessage").
        with(body: "channel=12345&thread_ts=0&text=tra+la+la+la+la&as_user=true", headers: {"Content-Type" => "application/x-www-form-urlencoded", "Authorization" => "Bearer ABC-123-DEF-456"})
        .to_return(
          status: 200, 
