...
module Slack
    module Api
        module Event
            describe Slack::Api::Event::EventParser do
                describe "#to_event" do
                    it "Returns the CHANNEL event type enum val in the hash" do
                        ...
                        event = Slack::Api::Event::EventParser.new(JSON.parse(input)).to_event
                    ...
                    it "Raises an invalid Json Exception if the channel/event type is invalid" do
                        ...
                        expect_raises(InvalidJsonException, "json invalid") do
                            Slack::Api::Event::EventParser.new(JSON.parse(input)).to_event
                        end
                    end
